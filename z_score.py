...
fig.add_trace(go.Scatter(x=[first_std_deviation_start, first_std_deviation_end], y=[0, 1.4], mode="lines", name="STANDARD DEVIATION 1 END"))
fig.add_trace(go.Scatter(x=[second_std_deviation_start, second_std_deviation_end], y=[0, 1.4], mode="lines", name="STANDARD DEVIATION 2 END"))
fig.add_trace(go.Scatter(x=[third_std_deviation_start, third_std_deviation_end], y=[0, 1.4], mode="lines", name="STANDARD DEVIATION 3 END"))
fig.show()
